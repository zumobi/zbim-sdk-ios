...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image backgroundColor:(UIColor *)backgroundColor;
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position {
    ...
    toast = [self viewForMessage:message title:nil image:nil backgroundColor:nil];
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position backgroundColor:(UIColor *)backgroundColor {
    ...
    toast = [self viewForMessage:message title:nil image:nil backgroundColor:backgroundColor];
    [self showToast:toast duration:duration position:position];
}
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position title:(NSString *)title {
    ...
    toast = [self viewForMessage:message title:title image:nil backgroundColor:nil];
    [self showToast:toast duration:duration position:position];
}
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position image:(UIImage *)image {
    ...
    toast = [self viewForMessage:message title:nil image:image backgroundColor:nil];
    [self showToast:toast duration:duration position:position];
}
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration  position:(id)position title:(NSString *)title image:(UIImage *)image {
    ...
    toast = [self viewForMessage:message title:title image:image backgroundColor:nil];
    [self showToast:toast duration:duration position:position];
}
...
- (CGSize)sizeForString:(NSString *)string font:(UIFont *)font constrainedToSize:(CGSize)constrainedSize lineBreakMode:(NSLineBreakMode)lineBreakMode {
    if ([string isMemberOfClass:[NSAttributedString class]])
    {
        NSAttributedString *attributedString = (NSAttributedString *)string;
        CGRect boundingRect = [attributedString boundingRectWithSize:constrainedSize options:NSStringDrawingUsesLineFragmentOrigin context:nil];
    ...
    return [string boundingRectWithSize:constrainedSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image backgroundColor:(UIColor *)backgroundColor {
    ...
    wrapperView.backgroundColor = backgroundColor ? [backgroundColor colorWithAlphaComponent:CSToastOpacity] : [[UIColor blackColor] colorWithAlphaComponent:CSToastOpacity];
